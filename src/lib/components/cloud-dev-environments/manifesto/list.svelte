...
<Section class="flex flex-col items-center justify-center w-full">
  ...
  <ol
    class="list-outside columns-1 md:columns-2 gap-xx-large space-y-small py-0 p-medium lg:pl-x-large"
  >
    {#each manifestoItems as item}
      <li
        class="marker:mr-x-small break-inside-avoid marker:text-primary marker:text-h4"
      >
        <h3 class="!mb-micro lg:!mb-xx-small">
